  ...
  group('VersionExt tests', () {
    ...
    test(
      ...
      () {
        ...
        expect(Version.parse('0.12.1+dev.5').marketingVersion, equals('0.12.1'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(version.copyWith(build: 'strBuild').build, orderedEquals(['strBuild']));
        expect(version.copyWith(pre: 'strPre').preRelease, orderedEquals(['strPre']));
        expect(
          version.copyWith(major: 20, minor: 7, patch: 150, build: 'dev.17', pre: 'pre.5'),
